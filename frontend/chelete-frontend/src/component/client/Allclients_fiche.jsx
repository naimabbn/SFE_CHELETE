...
export default class Allclients extends Component {
    ...
    this.redirectDevis=this.redirectDevis.bind(this)
...
redirectFicheCredit(id){
  this.props.history.push(`/fichecredit/${id}`)
}
  render() {
    return (
      <div>
      ...
      <div className='main'>
              <Navbar/> 
      <div className='body'>
        <h2 className='titre'>Fiche crédit - sélectionner un client</h2>
...
<td></td>
                ...
                {this.state.clients.length === 0 ? (
                    ...
                    <tr key={client.id_client}>
                        ...
                        <td>      
                              <a onClick={()=>this.redirectFicheCredit(client.id_client)} >  <GrAdd style={{color:'bleu'}}/></a>
                        </td>
      </tr>
    ))
  )}
